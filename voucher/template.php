...
<!-- Logo Hotspotname -->
    <tr>
      <td style="text-align: left; font-size: 14px; font-weight:bold; border-bottom: 1px black solid;"><img src="<?php echo $logo;?>" alt="logo" style="height:30px;border:0;">  <br> Computer and Network Engineering  <span id="num"><?php echo " [$num]";?></span></td>
    </tr>
<!-- /  -->
    <tr>
      <td>
...
<!-- /  -->
    ...
    <tr>
      <!-- Note  -->
      <td colspan="2" style="font-weight:bold; font-size:12px">Alamat Login: http://<?php echo $dnsname;?></td>
<!-- /  -->
    </tr>
 <tr>
      <!-- Note  -->
      <td colspan="2" style="font-weight:bold; font-size:12px">Tlp/WA/Tele : 082337481227 </td>
<!-- /  -->
    </tr>
<!-- /  -->
  </tbody>
